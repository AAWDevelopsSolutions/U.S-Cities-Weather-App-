window.addEventListener('DOMContentLoaded', () => {
  ...
  const iconMap = {
    0: "assets/sunny-icon.svg",
    1: "assets/sunny-icon.svg",
    2: "assets/partly-cloudy-icon.svg",
    3: "assets/fog-icon.svg",
    45: "assets/fog-icon.svg",
    48: "assets/rime-ice-icon.svg",
    51: "assets/drizzle-icon.svg",
    53: "assets/drizzle-icon.svg",
    55: "assets/drizzle-icon.svg",
    56: "assets/drizzle-icon.svg",
    57: "assets/drizzle-icon.svg",
    61: "assets/drizzle-icon.svg",
    63: "assets/rain-icon.svg",
    65: "assets/rain-icon.svg",
    66: "assets/drizzle-icon.svg",
    67: "assets/rain-icon.svg",
    71: "assets/icy-icon.svg",
    73: "assets/snow-icon.svg",
    75: "assets/blizzard-icon.svg",
    77: "assets/icy-icon.svg",
    80: "assets/rain-icon.svg",
    81: "assets/rain-icon.svg",
    82: "assets/rainstorm-icon.svg",
    85: "assets/snow-icon.svg",
    86: "assets/blizzard-icon.svg",
    95: "assets/stormy-icon.svg",
    96: "assets/hail-icon.svg",
    99: "assets/severe-weather-icon.svg",
  };
